...
export async function saveOnboarding(
  ...
  switch (input.step) {
    ...
    case "finish": {
      // A completed onboarding requires at least a name (the required steps
      // can't finish without a name + email). The date-of-birth step and its
      // age gate were removed from the flow.
